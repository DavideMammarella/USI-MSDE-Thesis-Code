...
def quantify_uncertainty_thread(image):
    ...
    quantify_uncertainty_thread.has_been_called = True
    outputs, unc = model.predict_quantified(image, quantifier="STD")
    ...
    if data:
        ...
        try:
            ...
            if cfg.USE_PREDICTIVE_UNCERTAINTY:
                ...
                # # call unc thread every 10 seconds
                # outputs, unc = quantify_uncertainty_thread(image)
                #
                # if quantify_uncertainty_thread.has_been_called:
